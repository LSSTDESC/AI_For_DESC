...
%\documentclass[modern, linenumbers]{lsstdescnote_customized}
...
% Commands for hyperlinking acronyms:
% \acrshort{...}: short form, hyperlinked
% \acrlong{...}: long form, hyperlinked
% \acrfull{...}: short (long)
% \Acr[long/short/full]{...}: as above, but with first letter capitalized
% \[A/a]cr[long/short/full]pl{...}: as above, but plural
